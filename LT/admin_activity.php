...
<html lang="en">
<head>
<title>LabTrack - Admin Panel</title>
<meta charset="utf-8">
...
<div class="row-2 slog">
  <nav>
    <ul class="menu">
      <li><a class="active" href="admin_activity.php">Details<span style="color:#F00; text-shadow:none;"></span></a></li>
...
<h1 style="text-align:center; font-size:24px; padding:20px; text-decoration:underline;">&raquo; &nbsp;Bug which are not solved having High Priority...</h1></br></br></br>
 <?php
$q="SELECT * FROM `report_tbl` WHERE `status`=0 AND `priority`=3 AND date<now()-(60*60*24*7) ORDER BY `id` DESC";
$res=mysql_query($q,$con) or die("There is an error");
?>		
<ul id="toggle-view">
  <li>
    <h3>            
            <div class="sp" style="width:30px;">ID</div>
...
<ul id="toggle-view">
  <li>
    <h3>            
            <div class="sp" style="width:30px;"><?php echo $arr['id']?></div>
    ...
    <div class="panel" style="display: none;">
      <p><?php echo $arr['detail'];?></p>
		...
		?>
<h1 style="text-align:center; font-size:24px; padding:20px; text-decoration:underline;">&raquo; &nbsp;Bug which are not solved having Medium Priority...</h1></br></br></br>
 <?php
$q="SELECT * FROM `report_tbl` WHERE `status`=0 AND `priority`=2 AND date<now()-(60*60*24*7) ORDER BY `id` DESC";
$res=mysql_query($q,$con) or die("There is an error");
?>		
<ul id="toggle-view">
  <li>
  ...
  <li>
    ...
    <div class="panel" style="display: none;">
      ...
      <p><?php if($arr['li_comment'] != null )	echo "<hr/>".$arr['li_comment'];?></p>
		...
		?>
<h1 style="text-align:center; font-size:24px; padding:20px; text-decoration:underline;">&raquo; &nbsp;Bug which are not solved having Low Priority...</h1></br></br></br>
 <?php
$q="SELECT * FROM `report_tbl` WHERE `status`=0 AND `priority`=1 AND date<now()-(60*60*24*7) ORDER BY `id` DESC";
$res=mysql_query($q,$con) or die("There is an error");
?>		
<ul id="toggle-view">
  <li>
