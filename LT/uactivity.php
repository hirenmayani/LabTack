...
<div class="row-2 slog">
  <nav>
    <ul class="menu">
      ...
      <li><a class="active"  href="uactivity.php">Activity<span style="color:#F00; text-shadow:none;"></span></a></li>
...
?>
	...
	else if(isset($_SESSION['lt_admin']))
		$user=$_SESSION['lt_admin'];
		?>

<h1 style="text-align:center; font-size:24px; padding:20px; text-decoration:underline;">&raquo; &nbsp;History of bug you submitted</h1></br></br></br>
            <?php

$q="SELECT * FROM `report_tbl` WHERE 1 ORDER BY `id` DESC";
...
<ul id="toggle-view">
  <li>
    <h3>
            ...
            <div class="sp" style="width:60px;">Lab No.</div>
            <div class="sp" style="width:40px;">PC No.</div>
            <div class="sp" style="width:50px;">Priority</div>
            <div class="sp" style="width:90px;">Resolved By</div>
...
<ul id="toggle-view">
  <li>
    <h3>            
            ...
            <div class="sp" style="width:60px;"><?php echo $arr['labno']?></div>
            <div class="sp" style="width:40px;"><?php echo $arr['pcno']?></div>
            <div class="sp" style="width:50px;"><?php echo $arr['priority']?></div>
            <div class="sp" style="width:90px;"><?php echo $arr['solver']?></div>
